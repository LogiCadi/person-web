...
const q = [],
  ...
  an = (e, t, n) => {
    ...
    let v;
    (v = l.match(Le)) && ((l = l.replace(Le, "").trim()), (u = v[1].trim()), v[2] && (p = v[2].trim())),
      (v = l.match(fn)) && ((f = v[1].split(",").map((m) => m.trim())), (a = l[0] === "["));
    let pe = !1,
      R,
      L,
      J;
          ...
          for (; d--; ) {
            ...
            M == null
              ...
              : ((E = R[M]),
                ...
                M !== d && (R[M + 1] !== g || P === g) && ((P = E), E.insert(i, g ? g.el : c))),
              h.unshift((g = E));
          }
          R = h;
        }
...
const Fe = (e, t) => {
    ...
    if (n === 1) {
      ...
      for (const { name: o, value: l } of [...s.attributes])
        un.test(o) &&
          o !== "v-cloak" &&
          (o === "v-model" ? c.unshift([o, l]) : o[0] === "@" || /^v-on\b/.test(o) ? c.push([o, l]) : Je(s, o, l, t));
...
class ue {
  constructor(t, n, s = !1) {
    ...
    (this.isFragment = t instanceof HTMLTemplateElement),
      ...
      s ? (this.ctx = n) : ((this.parentCtx = n), n.blocks.push(this), (this.ctx = Ze(n))),
      ...
      mount(s) {
        ...
        return (
          s.hasAttribute("v-scope")
            ? (r = [s])
            : (r = [...s.querySelectorAll("[v-scope]")].filter((i) => !i.matches("[v-scope] [v-scope]"))),
          r.length || (r = [s]),
